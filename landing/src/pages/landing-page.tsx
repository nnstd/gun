...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        <section className="mx-auto grid max-w-370 gap-14 px-5 pb-16 pt-16 sm:px-8 lg:grid-cols-[minmax(0,1.35fr)_minmax(380px,1fr)] lg:items-center lg:px-12 lg:pb-20 lg:pt-24">
          <div>
        ...
        <section className="border-y border-white/10">
          <div className="mx-auto grid max-w-370 gap-8 px-5 py-10 sm:px-8 lg:grid-cols-[220px_minmax(0,1fr)] lg:items-center lg:px-12">
        ...
        <section
          id="playground"
          className="mx-auto max-w-350 px-5 py-20 sm:px-8 lg:px-12 lg:py-24"
        >
          <SectionLabel>Live Transpilation</SectionLabel>
          <h2 className="font-syne text-[clamp(2rem,4vw,3rem)] font-extrabold tracking-tighter text-white">
        ...
        <section
          id="benchmarks"
          className="mx-auto max-w-370 px-5 py-20 sm:px-8 lg:px-12 lg:py-24"
        >
          <div className="grid gap-8 lg:grid-cols-2 lg:items-end">
            <div>
              <SectionLabel>02 / Receipts</SectionLabel>
              <h2 className="text-balance font-syne text-[clamp(2.2rem,4vw,3.5rem)] font-extrabold leading-[1.02] tracking-tighter text-white">
          ...
          <div className="mt-10 overflow-hidden rounded-3xl border border-white/10 bg-panel">
            ...
            <div className="divide-y divide-white/10">
              {BENCHMARK_ROWS.map((row) => (
                ...
                >
                  ...
                  <MetricCell label="Bun 1.3" value={row.bun} accent="muted" />
                  <MetricCell
                    label="Gun -> Go"
                    value={row.gun}
                    accent="brand"
        ...
        >
          ...
          <div className="mt-10 grid overflow-hidden rounded-3xl border border-white/10 bg-panel lg:grid-cols-5">
        ...
        <section className="mx-auto max-w-370 px-5 py-20 sm:px-8 lg:px-12 lg:py-24">
          <SectionLabel>04 / What you get</SectionLabel>
          <h2 className="max-w-2xl font-syne text-[clamp(2.2rem,4vw,3.5rem)] font-extrabold leading-[1.02] tracking-tighter text-white">
        ...
        <section className="mx-auto max-w-370 px-5 py-12 sm:px-8 lg:px-12 lg:py-16">
          <div className="grid gap-8 rounded-[28px] border border-brand-300/35 bg-[linear-gradient(135deg,rgba(66,68,147,0.18)_0%,rgba(66,68,147,0.04)_100%)] px-6 py-8 lg:grid-cols-[auto_1fr] lg:items-center lg:px-12 lg:py-12">
            <div className="font-syne text-7xl font-extrabold leading-none text-brand-300/45">
              &ldquo;
            </div>
            <div>
              <p className="font-syne text-[clamp(1.4rem,3vw,2rem)] font-bold leading-tight tracking-[-0.04em] text-white">
        ...
        <section className="mx-auto grid max-w-370 gap-14 px-5 py-20 sm:px-8 lg:grid-cols-[0.95fr_1.45fr] lg:px-12 lg:py-24">
          <div>
        ...
        <section className="mx-auto max-w-370 px-5 pb-24 sm:px-8 lg:px-12 lg:pb-30">
          <div className="relative overflow-hidden rounded-[30px] border border-brand-300/40 bg-[radial-gradient(ellipse_80%_100%_at_50%_100%,rgba(66,68,147,0.4)_0%,rgba(8,8,15,0.95)_70%)] px-6 py-10 lg:px-14 lg:py-16">
            <div className="absolute inset-0 bg-[linear-gradient(rgba(66,68,147,0.08)_1px,transparent_1px),linear-gradient(90deg,rgba(66,68,147,0.08)_1px,transparent_1px)] bg-size-[48px_48px] mask-[radial-gradient(ellipse_60%_80%_at_50%_100%,#000,transparent)]" />
...
function CodePanel({
  ...
  return (
    <div className="min-w-0">
      ...
      {highlighted ? (
        <div
          className="overflow-hidden px-3 py-6 text-[12px] sm:text-[13px] [&_.shiki-demo]:m-0 [&_.shiki-demo]:bg-transparent [&_.shiki-demo]:p-0 [&_.shiki-demo]:font-mono [&_.shiki-demo]:text-white/90 [&_.shiki-demo]:text-[12px] sm:[&_.shiki-demo]:text-[13px] [&_.shiki-demo__code]:grid [&_.line]:block [&_.line]:leading-0"
          dangerouslySetInnerHTML={{ __html: highlighted }}
        />
      ) : (
        <pre className="overflow-hidden px-3 py-6 font-mono text-[12px] text-white/90 sm:text-[13px]">
          <code>{code}</code>
        </pre>
      )}
    </div>
